    ...
    try {
      ...
      try {
        final activos = await supabase
            ...
            // universal funcione igual sin internet (schema_v59). es_kit,
            // para que sin internet un kit no parezca un equipo normal
            // (schema_v64).
            .select('*, activo_referencias(nombre, marca, modelo, tipo, es_kit), '
